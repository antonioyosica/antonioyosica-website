...
import { BookOpen, ChevronLeft, ChevronRight, Settings, Moon, Sun, Type, Bookmark, ArrowLeft, Lock, Eye } from 'lucide-react'
...
export default function LerLivroPage() {
  ...
  const isLastFreeChapter = currentChapter === 3
